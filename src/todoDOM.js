...
const addTodoButtonFunctionality = () => {
  ...
  descriptionTodos.forEach((descriptionTodo) =>
    descriptionTodo.addEventListener("click", (e) => {
      //console.log(e.target.parentNode.nextElementSibling);
      let target = e.target.parentNode;
      if (target.classList.contains("change") === false)
        target.classList.add("change");
      else target.classList.remove("change");
      if (target.nextElementSibling.classList.contains("show") === false)
        target.nextElementSibling.classList.add("show");
      else target.nextElementSibling.classList.remove("show");
      //console.log(e);
    })
  );
};
